max_score = 20  # This value is pulled by yml_generator.py to assign a score to this test.
...
def test_02_printed_messages(test_cases):
    try:
        ...
        for test_case in test_cases:
            ...
            _, captured_output, _, _, _ = load_student_code(inputs, test_case)
